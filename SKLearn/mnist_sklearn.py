...
def load_mnist():
    ...
    # take 10% of the training data and use that for validation
    (trainData, valData_, trainLabels, valLabels_) = train_test_split(trainData, trainLabels, test_size=0.9990,
                                                                    random_state=84)
    # take 10% of the training data and use that for validation
...
# trainData, testData, valData, trainLabels, testLabels, valLabels = load_data_()
trainData, testData, valData, trainLabels, testLabels, valLabels = load_mnist()
